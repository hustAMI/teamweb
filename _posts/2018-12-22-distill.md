...
<details class="custom-details" style="margin: 1em 0; padding: 0.5em; border: 1px solid #e0e0e0; border-radius: 4px;">
  <summary style="cursor: pointer; font-weight: bold; outline: none;">Click here to know more</summary>
  <div style="margin-top: 0.5em; padding-top: 0.5em; border-top: 1px dashed #e0e0e0;">
    Additional details, where math $$ 2x - 1 $$ and <code>code</code> is rendered correctly.
    
    <!-- 如果需要多行代码块，可以使用<pre><code>标签 -->
    <pre style="background: #f5f5f5; padding: 0.5em; border-radius: 3px; overflow-x: auto;"><code>def example():
    print("This code block will render correctly")</code></pre>
  </div>
</details>
